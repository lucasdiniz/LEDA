...
public class StudentSplayTreeTest {
	...
	public void test1(){
		...
		splay.insert(3);
//
//		System.out.println(splay.getRoot().getData());
//		System.out.println(splay.getRoot().getRight().getData());
//		System.out.println(splay.getRoot().getRight().getLeft().getData());
		assertEquals(splay.getRoot().getData(), new Integer(3));
	}
...
//		assertArrayEquals(new Integer[] { -15, 5, 99 }, preOrder);
	}
